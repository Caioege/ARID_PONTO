...
## Repository map
- `alteracoes_20260315.sql/` — explain what lives here and when agents should edit it.
- `alteracoes.sql/` — explain what lives here and when agents should edit it.
- `aprovacao_tolerancia.sql/` — explain what lives here and when agents should edit it.
...
- `auditoria_ausencias.sql/` — explain what lives here and when agents should edit it.
