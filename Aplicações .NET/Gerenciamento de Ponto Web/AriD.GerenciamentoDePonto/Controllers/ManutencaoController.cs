    ...
    public class ManutencaoController : BaseController
    {
        ...
        public async Task<IActionResult> Salvar(ManutencaoVeiculo manutencao)
        {
            ...
            else
            {
                ...
                original.Categoria = manutencao.Categoria;
                ...
                original.DataAgendamento = manutencao.DataAgendamento;
                original.DataConclusao = manutencao.DataConclusao;
                original.GarantiaAte = manutencao.GarantiaAte;
                original.LocalExecucaoServico = manutencao.LocalExecucaoServico;
                original.Fornecedor = manutencao.Fornecedor;
                original.ResponsavelServico = manutencao.ResponsavelServico;
                original.ContatoFornecedor = manutencao.ContatoFornecedor;
                original.NumeroDocumento = manutencao.NumeroDocumento;
                original.CustoPrevisto = manutencao.CustoPrevisto;
                original.ValorMaximoAutorizado = manutencao.ValorMaximoAutorizado;
                original.ValorTotalGasto = manutencao.ValorTotalGasto;
