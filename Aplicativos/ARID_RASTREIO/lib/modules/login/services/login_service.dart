...
import 'package:arid_rastreio/modules/login/dto/auth_response_dto.dart';
...
class LoginService {
  ...
  Future<AuthResponseDTO> login(String login, String senha, {String? tipoAcesso}) async {
    ...
    if (useFakeLogin) {
      ...
      final usuarioMock = UsuarioDTO(
        id: 1,
        nome: tipoAcesso == 'motorista' ? 'Motorista Teste' : 'Acompanhante Teste',
        login: login,
        foto: null,
      );
      ...
      return AuthResponseDTO(
        token: 'fake-token-arid-rastreio',
        usuario: usuarioMock,
      );
    }
    ...
    final response = await _client.post(
      '/api/rastreio-app/autentique',
      data: {
        'usuario': login, // Mapeia para Usuario no DTO
        'senha': senha,
