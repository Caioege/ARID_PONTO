...
namespace AriD.Servicos.Repositorios
{
    public class Repositorio<T> : IRepositorio<T> where T : EntidadeBase
    {
        ...
        // TODO: Adicionar filtro de redeDeEnsino
        private readonly int? RedeDeEnsinoId;
        ...
        {
            if (RedeDeEnsinoId.HasValue && typeof(T).IsAssignableFrom(typeof(EntidadeRedeDeEnsinoBase)))
                (entidade as EntidadeRedeDeEnsinoBase).RedeDeEnsinoId = RedeDeEnsinoId.Value;
